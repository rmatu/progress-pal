...
import { HeaderWrapper, RestContentWrapper } from "./styles";
...
const Privacy: React.FC<PrivacyProps> = () => (
  <>
    ...
    <RestContentWrapper
      ...
      exit={{ y: -50, opacity: 0 }}
    >
      <h1>Privacy Policy for ProgressPal</h1>

      <p>
        At ProgressPal, accessible from https://progresspal.com, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        ProgressPal and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in ProgressPal. This policy is not applicable to
      ...
      <p>
        ProgressPal follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, ProgressPal uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of ProgressPal.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on ProgressPal, which are sent
      ...
      <p>
        Note that ProgressPal has no access to or control over these cookies
      ...
      <p>
        ProgressPal's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ProgressPal does not knowingly collect any Personal Identifiable
